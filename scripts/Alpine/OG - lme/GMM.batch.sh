...
int_BLUPs = "${data_dir}/results/lmeR_spline_RE_blup.qs"
lmer_int_res = "${data_dir}/results/lmeR_spline_RE_blup_int.qs"
...
Rscript "$r_script" "$int_BLUPs" "$lmer_int_res" "$out_csv" 
