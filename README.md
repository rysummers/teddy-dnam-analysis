...
R/          Contains reusable R functions sourced by analysis scripts and
            reports to promote reproducible code.

scripts/    Analysis scripts executed to perform data processing, CpG
            annotation, and exploratory analyses.

reports/    Reproducible analysis reports written in R Markdown,
            integrating results, figures, and interpretations.

results/    Output files generated by analysis scripts, including summary
            tables and intermediate results (excluding sensitive data).

figures/    Visualizations and plots generated during analysis for reporting
            and interpretation.

docs/       General project documentation and supporting materials not
            directly part of the analysis pipeline.
